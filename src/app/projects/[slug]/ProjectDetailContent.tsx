...
import type { projects } from "@/data/company";
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                {images.map((img, i) => (
                                    <motion.button
                                        ...
                                        className={`relative aspect-[4/3] overflow-hidden border-2 transition-colors duration-300 ${activeImage === i ? "border-gold" : "border-transparent"
                                            }`}
                                    >
                                        <Image
                                            src={img}
                                            alt={`${project.name} ${project.category.toLowerCase()} in ${project.location} — view ${i + 1}`}
                                            fill
