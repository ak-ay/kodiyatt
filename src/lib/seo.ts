  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          "Construction company in Kerala offering residential construction, commercial construction, interior design, landscape design, renovation and consultation services across premium, standard and budget-friendly project tiers.",
        ...
        address: {
          ...
          addressLocality: company.contact.locality,
          addressRegion: company.contact.region,
